...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDDMM_Statics::Class_MetaDataParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDDMM_Statics::ClassParams = {
		&UDDMM::StaticClass,
		nullptr,
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(Z_Construct_UClass_UDDMM_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDDMM_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UDDMM()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDDMM_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDDMM, 4107492801);
