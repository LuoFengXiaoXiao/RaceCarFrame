...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDDDefine_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDDDefine_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDDDefine_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UDDDefine()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDDDefine_Statics::ClassParams);
		}
		return OuterClass;
	}
