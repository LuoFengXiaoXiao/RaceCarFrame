...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDDInputBinder_Statics::Class_MetaDataParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDDInputBinder_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDDInputBinder_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDDInputBinder_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UDDInputBinder()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDDInputBinder_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDDInputBinder, 2649449697);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDDMessage_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "DDCore/DDMessage.h" },
		{ "ModuleRelativePath", "Public/DDCore/DDMessage.h" },
	};
#endif
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDDMessage_Statics::InterfaceParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDDMessage_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDDMessage_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDDMessage_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UDDMessage()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDDMessage_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDDMessage, 685258407);
