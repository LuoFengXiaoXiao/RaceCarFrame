...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDDObject_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "DDObject/DDObject.h" },
		{ "ModuleRelativePath", "Public/DDObject/DDObject.h" },
	};
#endif
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDDObject_Statics::InterfaceParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDDObject_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDDObject_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDDObject_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UDDObject()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDDObject_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDDObject, 2687244540);
