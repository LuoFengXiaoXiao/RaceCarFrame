...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDDUserWidget_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "DDObject/DDUserWidget.h" },
		{ "ModuleRelativePath", "Public/DDObject/DDUserWidget.h" },
	};
#endif
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDDUserWidget_Statics::InterfaceParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDDUserWidget_Statics::ClassParams = {
		...
		0x00B010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDDUserWidget_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDDUserWidget_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UDDUserWidget()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDDUserWidget_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDDUserWidget, 1749194962);
