...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDDModel_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "DDCore/DDModel.h" },
		{ "ModuleRelativePath", "Public/DDCore/DDModel.h" },
	};
#endif
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDDModel_Statics::InterfaceParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDDModel_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDDModel_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDDModel_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UDDModel()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDDModel_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDDModel, 4210911979);
