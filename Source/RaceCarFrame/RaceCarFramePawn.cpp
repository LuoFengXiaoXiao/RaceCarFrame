...
#include "RaceCarFrameWheelFront.h"
#include "RaceCarFrameWheelRear.h"
...
#include "../../Plugins/DataDriven/Source/DataDriven/Public/DDCommon/DDCommon.h"

const FName ARaceCarFramePawn::LookUpBinding("LookUp");
const FName ARaceCarFramePawn::LookRightBinding("LookRight");
const FName ARaceCarFramePawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

PRAGMA_DISABLE_DEPRECATION_WARNINGS

ARaceCarFramePawn::ARaceCarFramePawn()
{
	// Car mesh
	...
	{
		VehicleMovement->WheelSetups[0].WheelClass = URaceCarFrameWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[1].WheelClass = URaceCarFrameWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[2].WheelClass = URaceCarFrameWheelRear::StaticClass();
		...
		VehicleMovement->WheelSetups[3].WheelClass = URaceCarFrameWheelRear::StaticClass();
...
void ARaceCarFramePawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ARaceCarFramePawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ARaceCarFramePawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ARaceCarFramePawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ARaceCarFramePawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ARaceCarFramePawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ARaceCarFramePawn::OnResetVR); 
}

void ARaceCarFramePawn::MoveForward(float Val)
{
	if (Val > 0)
	{
...
void ARaceCarFramePawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void ARaceCarFramePawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ARaceCarFramePawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ARaceCarFramePawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ARaceCarFramePawn::EnableIncarView(const bool bState)
{
...
void ARaceCarFramePawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ARaceCarFramePawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void ARaceCarFramePawn::UpdateHUDStrings()
{
...
void ARaceCarFramePawn::SetupInCarHUD()
{
...
void ARaceCarFramePawn::UpdatePhysicsMaterial()
{
